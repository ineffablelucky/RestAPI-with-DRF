...
from Products.api.views import CategoryListAPIView, SubcategoryListAPIView, ProductCategoryListAPIView,ProductSubcategoryListAPIView,ProductCreateAPIView
...
urlpatterns = [
    ...
    path('addproduct/', ProductCreateAPIView.as_view(), name = 'Productcreate'),
]
